(globalThis.TURBOPACK||(globalThis.TURBOPACK=[])).push(["object"==typeof document?document.currentScript:void 0,40924,(e,t,o)=>{"use strict";Object.defineProperty(o,"__esModule",{value:!0});var n={assign:function(){return h},searchParamsToUrlQuery:function(){return a},urlQueryToSearchParams:function(){return s}};for(var r in n)Object.defineProperty(o,r,{enumerable:!0,get:n[r]});function a(e){let t={};for(let[o,n]of e.entries()){let e=t[o];void 0===e?t[o]=n:Array.isArray(e)?e.push(n):t[o]=[e,n]}return t}function i(e){return"string"==typeof e?e:("number"!=typeof e||isNaN(e))&&"boolean"!=typeof e?"":String(e)}function s(e){let t=new URLSearchParams;for(let[o,n]of Object.entries(e))if(Array.isArray(n))for(let e of n)t.append(o,i(e));else t.set(o,i(n));return t}function h(e,...t){for(let o of t){for(let t of o.keys())e.delete(t);for(let[t,n]of o.entries())e.append(t,n)}return e}},47589,(e,t,o)=>{"use strict";Object.defineProperty(o,"__esModule",{value:!0});var n={DecodeError:function(){return w},MiddlewareNotFoundError:function(){return k},MissingStaticPage:function(){return b},NormalizeError:function(){return p},PageNotFoundError:function(){return v},SP:function(){return g},ST:function(){return m},WEB_VITALS:function(){return a},execOnce:function(){return i},getDisplayName:function(){return d},getLocationOrigin:function(){return u},getURL:function(){return l},isAbsoluteUrl:function(){return h},isResSent:function(){return y},loadGetInitialProps:function(){return f},normalizeRepeatedSlashes:function(){return c},stringifyError:function(){return I}};for(var r in n)Object.defineProperty(o,r,{enumerable:!0,get:n[r]});let a=["CLS","FCP","FID","INP","LCP","TTFB"];function i(e){let t,o=!1;return(...n)=>(o||(o=!0,t=e(...n)),t)}let s=/^[a-zA-Z][a-zA-Z\d+\-.]*?:/,h=e=>s.test(e);function u(){let{protocol:e,hostname:t,port:o}=window.location;return`${e}//${t}${o?":"+o:""}`}function l(){let{href:e}=window.location,t=u();return e.substring(t.length)}function d(e){return"string"==typeof e?e:e.displayName||e.name||"Unknown"}function y(e){return e.finished||e.headersSent}function c(e){let t=e.split("?");return t[0].replace(/\\/g,"/").replace(/\/\/+/g,"/")+(t[1]?`?${t.slice(1).join("?")}`:"")}async function f(e,t){let o=t.res||t.ctx&&t.ctx.res;if(!e.getInitialProps)return t.ctx&&t.Component?{pageProps:await f(t.Component,t.ctx)}:{};let n=await e.getInitialProps(t);if(o&&y(o))return n;if(!n)throw Object.defineProperty(Error(`"${d(e)}.getInitialProps()" should resolve to an object. But found "${n}" instead.`),"__NEXT_ERROR_CODE",{value:"E1025",enumerable:!1,configurable:!0});return n}let g="u">typeof performance,m=g&&["mark","measure","getEntriesByName"].every(e=>"function"==typeof performance[e]);class w extends Error{}class p extends Error{}class v extends Error{constructor(e){super(),this.code="ENOENT",this.name="PageNotFoundError",this.message=`Cannot find module for page: ${e}`}}class b extends Error{constructor(e,t){super(),this.message=`Failed to load static file for page: ${e} ${t}`}}class k extends Error{constructor(){super(),this.code="ENOENT",this.message="Cannot find the middleware module"}}function I(e){return JSON.stringify({message:e.message,stack:e.stack})}},99355,(e,t,o)=>{"use strict";Object.defineProperty(o,"__esModule",{value:!0}),Object.defineProperty(o,"warnOnce",{enumerable:!0,get:function(){return n}});let n=e=>{}},36696,e=>{"use strict";let t="words-to-santhi-user";function o(){try{let e=localStorage.getItem(t);if("kingsuk"===e||"santhi"===e)return e}catch{}return"santhi"}function n(e){let t=o();return`wts:${t}:${e}`}function r(){try{return JSON.parse(localStorage.getItem(n("opened-letters"))||"[]")}catch{return[]}}function a(){try{return JSON.parse(localStorage.getItem(n("milestone-notes"))||"{}")}catch{return{}}}e.s(["addOpenedLetter",0,function(e){try{let t=r();t.includes(e)||(t.push(e),localStorage.setItem(n("opened-letters"),JSON.stringify(t)),window.dispatchEvent(new Event("storage")))}catch{}},"exportAllData",0,function(){let e={};try{for(let t=0;t<localStorage.length;t++){let o=localStorage.key(t);o&&o.startsWith("wts:")&&(e[o]=JSON.parse(localStorage.getItem(o)||"{}"))}}catch{}return JSON.stringify(e,null,2)},"getCurrentUser",0,o,"getMilestoneNotes",0,a,"getOpenedLetters",0,r,"importAllData",0,function(e){try{let t=JSON.parse(e);for(let e of Object.keys(t))e.startsWith("wts:")&&localStorage.setItem(e,JSON.stringify(t[e]));return window.dispatchEvent(new Event("storage")),!0}catch{return!1}},"resetAllProgress",0,function(){try{localStorage.removeItem(n("opened-letters")),localStorage.removeItem(n("milestone-notes")),window.dispatchEvent(new Event("storage"))}catch{}},"setCurrentUser",0,function(e){try{localStorage.setItem(t,e),localStorage.removeItem(n("opened-letters")),localStorage.removeItem(n("milestone-notes")),window.dispatchEvent(new Event("storage"))}catch{}},"setMilestoneNote",0,function(e,t,o){try{let r=a();r[e]={note:t,date:o},localStorage.setItem(n("milestone-notes"),JSON.stringify(r)),window.dispatchEvent(new Event("storage"))}catch{}}])},90037,e=>{"use strict";var t=e.i(51466),o=e.i(79959),n=e.i(36696);e.s(["default",0,function({letter:e,onClose:r}){let[a,i]=(0,o.useState)("envelope");return(0,o.useEffect)(()=>{if("opening"===a){let t=setTimeout(()=>{i("letter"),(0,n.addOpenedLetter)(e.id)},600);return()=>clearTimeout(t)}},[a,e.id]),(0,o.useEffect)(()=>{let e=e=>{"Escape"===e.key&&r()};return window.addEventListener("keydown",e),()=>window.removeEventListener("keydown",e)},[r]),(0,o.useEffect)(()=>(document.body.style.overflow="hidden",()=>{document.body.style.overflow=""}),[]),(0,t.jsxs)("div",{className:"fixed inset-0 z-50 flex items-center justify-center bg-black/80 p-4",onClick:e=>{e.target===e.currentTarget&&r()},role:"dialog","aria-modal":"true","aria-label":e.title,children:["envelope"===a&&(0,t.jsxs)("div",{className:"text-center animate-scale-in will-change-transform",children:[(0,t.jsx)("button",{onClick:()=>i("opening"),className:"group cursor-pointer bg-transparent border-none","aria-label":"Open letter",children:(0,t.jsxs)("div",{className:"w-48 h-56 sm:w-56 sm:h-64 bg-card rounded-lg border border-accent/30 relative flex items-center justify-center mx-auto transition-all duration-300 ease-out group-hover:border-accent group-hover:shadow-xl group-hover:shadow-accent/20 group-hover:scale-105 will-change-transform",children:[(0,t.jsxs)("svg",{viewBox:"0 0 24 24",className:"w-16 h-16 text-accent/70 group-hover:text-accent transition-colors duration-300",fill:"none",stroke:"currentColor",strokeWidth:"1.5",children:[(0,t.jsx)("rect",{x:"2",y:"4",width:"20",height:"16",rx:"2"}),(0,t.jsx)("path",{d:"M2 8l10 6 10-6"})]}),(0,t.jsx)("div",{className:"absolute bottom-4 left-4 right-4 text-center",children:(0,t.jsx)("p",{className:"text-xs text-secondary",children:"Click to open"})})]})}),(0,t.jsx)("h2",{className:"mt-6 text-xl font-heading text-text",children:e.title}),(0,t.jsx)("p",{className:"mt-1 text-sm text-secondary",children:e.description}),(0,t.jsx)("button",{onClick:r,className:"mt-4 text-xs text-secondary hover:text-accent transition-colors","aria-label":"Close",children:"Close"})]}),"opening"===a&&(0,t.jsx)("div",{className:"text-center will-change-transform",children:(0,t.jsx)("div",{className:"w-48 h-56 sm:w-56 sm:h-64 bg-card rounded-lg border border-accent/30 flex items-center justify-center mx-auto animate-envelope-open will-change-transform",children:(0,t.jsx)("svg",{viewBox:"0 0 24 24",className:"w-12 h-12 text-accent",fill:"none",stroke:"currentColor",strokeWidth:"1.5",children:(0,t.jsx)("path",{d:"M22 12h-4l-3 9L9 3l-3 9H2"})})})}),"letter"===a&&(0,t.jsxs)("div",{className:"bg-card border border-accent/30 rounded-lg max-w-2xl w-full max-h-[85vh] overflow-y-auto animate-letter-slide will-change-transform",children:[(0,t.jsxs)("div",{className:"sticky top-0 bg-card border-b border-accent/10 flex items-center justify-between p-4",children:[(0,t.jsx)("h2",{className:"text-lg font-heading text-accent pr-4",children:e.title}),(0,t.jsx)("button",{onClick:r,className:"text-secondary hover:text-text transition-colors shrink-0","aria-label":"Close letter",children:(0,t.jsx)("svg",{width:"20",height:"20",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:(0,t.jsx)("path",{d:"M18 6L6 18M6 6l12 12"})})})]}),(0,t.jsx)("div",{className:"p-6 sm:p-8 text-text leading-relaxed whitespace-pre-line text-sm sm:text-base animate-fade-in",children:e.content})]})]})}])},24170,e=>{"use strict";let t=[{id:"when-you-need-a-laugh",title:"When You Need A Laugh",description:"For the days when everything feels too serious.",category:"letter",order:1,content:`Dear Santhi,
