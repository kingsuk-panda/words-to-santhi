(globalThis.TURBOPACK||(globalThis.TURBOPACK=[])).push(["object"==typeof document?document.currentScript:void 0,40924,(e,t,o)=>{"use strict";Object.defineProperty(o,"__esModule",{value:!0});var n={assign:function(){return h},searchParamsToUrlQuery:function(){return r},urlQueryToSearchParams:function(){return s}};for(var a in n)Object.defineProperty(o,a,{enumerable:!0,get:n[a]});function r(e){let t={};for(let[o,n]of e.entries()){let e=t[o];void 0===e?t[o]=n:Array.isArray(e)?e.push(n):t[o]=[e,n]}return t}function i(e){return"string"==typeof e?e:("number"!=typeof e||isNaN(e))&&"boolean"!=typeof e?"":String(e)}function s(e){let t=new URLSearchParams;for(let[o,n]of Object.entries(e))if(Array.isArray(n))for(let e of n)t.append(o,i(e));else t.set(o,i(n));return t}function h(e,...t){for(let o of t){for(let t of o.keys())e.delete(t);for(let[t,n]of o.entries())e.append(t,n)}return e}},47589,(e,t,o)=>{"use strict";Object.defineProperty(o,"__esModule",{value:!0});var n={DecodeError:function(){return p},MiddlewareNotFoundError:function(){return k},MissingStaticPage:function(){return v},NormalizeError:function(){return w},PageNotFoundError:function(){return b},SP:function(){return m},ST:function(){return g},WEB_VITALS:function(){return r},execOnce:function(){return i},getDisplayName:function(){return d},getLocationOrigin:function(){return u},getURL:function(){return l},isAbsoluteUrl:function(){return h},isResSent:function(){return y},loadGetInitialProps:function(){return f},normalizeRepeatedSlashes:function(){return c},stringifyError:function(){return I}};for(var a in n)Object.defineProperty(o,a,{enumerable:!0,get:n[a]});let r=["CLS","FCP","FID","INP","LCP","TTFB"];function i(e){let t,o=!1;return(...n)=>(o||(o=!0,t=e(...n)),t)}let s=/^[a-zA-Z][a-zA-Z\d+\-.]*?:/,h=e=>s.test(e);function u(){let{protocol:e,hostname:t,port:o}=window.location;return`${e}//${t}${o?":"+o:""}`}function l(){let{href:e}=window.location,t=u();return e.substring(t.length)}function d(e){return"string"==typeof e?e:e.displayName||e.name||"Unknown"}function y(e){return e.finished||e.headersSent}function c(e){let t=e.split("?");return t[0].replace(/\\/g,"/").replace(/\/\/+/g,"/")+(t[1]?`?${t.slice(1).join("?")}`:"")}async function f(e,t){let o=t.res||t.ctx&&t.ctx.res;if(!e.getInitialProps)return t.ctx&&t.Component?{pageProps:await f(t.Component,t.ctx)}:{};let n=await e.getInitialProps(t);if(o&&y(o))return n;if(!n)throw Object.defineProperty(Error(`"${d(e)}.getInitialProps()" should resolve to an object. But found "${n}" instead.`),"__NEXT_ERROR_CODE",{value:"E1025",enumerable:!1,configurable:!0});return n}let m="u">typeof performance,g=m&&["mark","measure","getEntriesByName"].every(e=>"function"==typeof performance[e]);class p extends Error{}class w extends Error{}class b extends Error{constructor(e){super(),this.code="ENOENT",this.name="PageNotFoundError",this.message=`Cannot find module for page: ${e}`}}class v extends Error{constructor(e,t){super(),this.message=`Failed to load static file for page: ${e} ${t}`}}class k extends Error{constructor(){super(),this.code="ENOENT",this.message="Cannot find the middleware module"}}function I(e){return JSON.stringify({message:e.message,stack:e.stack})}},99355,(e,t,o)=>{"use strict";Object.defineProperty(o,"__esModule",{value:!0}),Object.defineProperty(o,"warnOnce",{enumerable:!0,get:function(){return n}});let n=e=>{}},90037,e=>{"use strict";var t=e.i(51466),o=e.i(79959),n=e.i(36696);e.s(["default",0,function({letter:e,onClose:a}){let[r,i]=(0,o.useState)("envelope"),s=(0,o.useCallback)(async()=>{await (0,n.addOpenedLetter)(e.id)},[e.id]);return((0,o.useEffect)(()=>(i("envelope"),document.body.style.overflow="hidden",()=>{document.body.style.overflow=""}),[e.id]),(0,o.useEffect)(()=>{"open"===r&&s()},[r,s]),"envelope"===r)?(0,t.jsx)("div",{className:"fixed inset-0 z-50 flex items-center justify-center bg-black/90 p-4",onClick:()=>i("open"),children:(0,t.jsx)("div",{className:"cursor-pointer perspective-3d will-change-transform animate-envelope-in",children:(0,t.jsxs)("div",{className:"w-64 h-44 bg-accent/20 border border-accent/30 rounded-lg flex flex-col items-center justify-center gap-1 relative shadow-xl shadow-accent/10",children:[(0,t.jsx)("span",{className:"text-accent text-xs tracking-widest uppercase",children:"A Letter"}),(0,t.jsx)("span",{className:"text-text text-sm text-center px-4 font-heading",children:e.title}),(0,t.jsx)("span",{className:"text-secondary text-[10px] mt-2",children:"click to open"}),(0,t.jsx)("div",{className:"absolute top-3 right-3 w-6 h-6 border-t-2 border-r-2 border-accent/40 rounded-tr-sm"})]})})}):(0,t.jsx)("div",{className:"fixed inset-0 z-50 flex items-end sm:items-center justify-center bg-black/90 p-0 sm:p-4",onClick:e=>{e.target===e.currentTarget&&a()},children:(0,t.jsxs)("div",{className:"bg-card border border-accent/20 rounded-t-2xl sm:rounded-lg max-w-lg w-full max-h-[85vh] flex flex-col animate-letter-slide will-change-transform",onClick:e=>e.stopPropagation(),children:[(0,t.jsxs)("div",{className:"flex items-center justify-between px-5 py-3 border-b border-accent/10 shrink-0",children:[(0,t.jsx)("div",{className:"min-w-0",children:(0,t.jsx)("h2",{className:"text-sm font-heading text-text truncate",children:e.title})}),(0,t.jsx)("button",{onClick:a,className:"shrink-0 text-secondary hover:text-text text-xs ml-4 p-1","aria-label":"Close letter",children:"✕"})]}),(0,t.jsx)("div",{className:"overflow-y-auto px-5 py-4 space-y-3 text-text text-sm leading-relaxed whitespace-pre-line",children:e.content.split("\n").map((e,o)=>e.trim()?(0,t.jsx)("p",{children:e},o):(0,t.jsx)("br",{},o))})]})})}])},24170,e=>{"use strict";let t=[{id:"when-you-need-a-laugh",title:"When You Need A Laugh",description:"For the days when everything feels too serious.",category:"letter",order:1,content:`Dear Santhi,
...
— Kingsuk`}];e.s(["letters",0,t])},33274,(e,t,o)=>{"use strict";Object.defineProperty(o,"__esModule",{value:!0});var n={formatUrl:function(){return s},formatWithValidation:function(){return u},urlObjectKeys:function(){return h}};for(var a in n)Object.defineProperty(o,a,{enumerable:!0,get:n[a]});let r=e.r(80471)._(e.r(40924)),i=/https?|ftp|gopher|file/;function s(e){let{auth:t,hostname:o}=e,n=e.protocol||"",a=e.pathname||"",s=e.hash||"",h=e.query||"",u=!1;t=t?encodeURIComponent(t).replace(/%3A/i,":")+"@":"",e.host?u=t+e.host:o&&(u=t+(~o.indexOf(":")?`[${o}]`:o),e.port&&(u+=":"+e.port)),h&&"object"==typeof h&&(h=String(r.urlQueryToSearchParams(h)));let l=e.search||h&&`?${h}`||"";return n&&!n.endsWith(":")&&(n+=":"),e.slashes||(!n||i.test(n))&&!1!==u?(u="//"+(u||""),a&&"/"!==a[0]&&(a="/"+a)):u||(u=""),s&&"#"!==s[0]&&(s="#"+s),l&&"?"!==l[0]&&(l="?"+l),a=a.replace(/[?#]/g,encodeURIComponent),l=l.replace("#","%23"),`${n}${u}${a}${l}${s}`}let h=["auth","hash","host","hostname","href","path","pathname","port","protocol","query","search","slashes"];function u(e){return s(e)}},59159,(e,t,o)=>{"use strict";Object.defineProperty(o,"__esModule",{value:!0}),Object.defineProperty(o,"useMergedRef",{enumerable:!0,get:function(){return a}});let n=e.r(79959);function a(e,t){let o=(0,n.useRef)(null),a=(0,n.useRef)(null);return(0,n.useCallback)(n=>{if(null===n){let e=o.current;e&&(o.current=null,e());let t=a.current;t&&(a.current=null,t())}else e&&(o.current=r(e,n)),t&&(a.current=r(t,n))},[e,t])}function r(e,t){if("function"!=typeof e)return e.current=t,()=>{e.current=null};{let o=e(t);return"function"==typeof o?o:()=>e(null)}}("function"==typeof o.default||"object"==typeof o.default&&null!==o.default)&&void 0===o.default.__esModule&&(Object.defineProperty(o.default,"__esModule",{value:!0}),Object.assign(o.default,o),t.exports=o.default)},47981,(e,t,o)=>{"use strict";Object.defineProperty(o,"__esModule",{value:!0}),Object.defineProperty(o,"isLocalURL",{enumerable:!0,get:function(){return r}});let n=e.r(47589),a=e.r(78117);function r(e){if(!(0,n.isAbsoluteUrl)(e))return!0;try{let t=(0,n.getLocationOrigin)(),o=new URL(e,t);return o.origin===t&&(0,a.hasBasePath)(o.pathname)}catch(e){return!1}}},17238,(e,t,o)=>{"use strict";Object.defineProperty(o,"__esModule",{value:!0}),Object.defineProperty(o,"errorOnce",{enumerable:!0,get:function(){return n}});let n=e=>{}},6295,(e,t,o)=>{"use strict";Object.defineProperty(o,"__esModule",{value:!0});var n={default:function(){return p},useLinkStatus:function(){return b}};for(var a in n)Object.defineProperty(o,a,{enumerable:!0,get:n[a]});let r=e.r(80471),i=e.r(51466),s=r._(e.r(79959)),h=e.r(33274),u=e.r(26165),l=e.r(59159),d=e.r(47589),y=e.r(44695);e.r(99355);let c=e.r(24402),f=e.r(79347),m=e.r(47981),g=e.r(45214);function p(t){var o,n;let a,r,p,[b,v]=(0,s.useOptimistic)(f.IDLE_LINK_STATUS),k=(0,s.useRef)(null),{href:I,as:x,children:T,prefetch:Y=null,passHref:j,replace:S,shallow:N,scroll:A,onClick:W,onMouseEnter:B,onTouchStart:E,legacyBehavior:P=!1,onNavigate:C,transitionTypes:D,ref:F,unstable_dynamicOnHover:O,...K}=t;a=T,P&&("string"==typeof a||"number"==typeof a)&&(a=(0,i.jsx)("a",{children:a}));let M=s.default.useContext(u.AppRouterContext),_=!1!==Y,L=!1!==Y?null===(n=Y)||"auto"===n?g.FetchStrategy.PPR:g.FetchStrategy.Full:g.FetchStrategy.PPR,R="string"==typeof(o=x||I)?o:(0,h.formatUrl)(o);if(P){if(a?.$$typeof===Symbol.for("react.lazy"))throw Object.defineProperty(Error("`<Link legacyBehavior>` received a direct child that is either a Server Component, or JSX that was loaded with React.lazy(). This is not supported. Either remove legacyBehavior, or make the direct child a Client Component that renders the Link's `<a>` tag."),"__NEXT_ERROR_CODE",{value:"E863",enumerable:!1,configurable:!0});r=s.default.Children.only(a)}let $=P?r&&"object"==typeof r&&r.ref:F,z=s.default.useCallback(e=>(null!==M&&(k.current=(0,f.mountLinkInstance)(e,R,M,L,_,v)),()=>{k.current&&((0,f.unmountLinkForCurrentNavigation)(k.current),k.current=null),(0,f.unmountPrefetchableInstance)(e)}),[_,R,M,L,v]),U={ref:(0,l.useMergedRef)(z,$),onClick(t){P||"function"!=typeof W||W(t),P&&r.props&&"function"==typeof r.props.onClick&&r.props.onClick(t),!M||t.defaultPrevented||function(t,o,n,a,r,i,h){if("u">typeof window){let u,{nodeName:l}=t.currentTarget;if("A"===l.toUpperCase()&&((u=t.currentTarget.getAttribute("target"))&&"_self"!==u||t.metaKey||t.ctrlKey||t.shiftKey||t.altKey||t.nativeEvent&&2===t.nativeEvent.which)||t.currentTarget.hasAttribute("download"))return;if(!(0,m.isLocalURL)(o)){a&&(t.preventDefault(),location.replace(o));return}if(t.preventDefault(),i){let e=!1;if(i({preventDefault:()=>{e=!0}}),e)return}let{dispatchNavigateAction:d}=e.r(20683);s.default.startTransition(()=>{d(o,a?"replace":"push",!1===r?c.ScrollBehavior.NoScroll:c.ScrollBehavior.Default,n.current,h)})}}(t,R,k,S,A,C,D)},onMouseEnter(e){P||"function"!=typeof B||B(e),P&&r.props&&"function"==typeof r.props.onMouseEnter&&r.props.onMouseEnter(e),M&&_&&(0,f.onNavigationIntent)(e.currentTarget,!0===O)},onTouchStart:function(e){P||"function"!=typeof E||E(e),P&&r.props&&"function"==typeof r.props.onTouchStart&&r.props.onTouchStart(e),M&&_&&(0,f.onNavigationIntent)(e.currentTarget,!0===O)}};return(0,d.isAbsoluteUrl)(R)?U.href=R:P&&!j&&("a"!==r.type||"href"in r.props)||(U.href=(0,y.addBasePath)(R)),p=P?s.default.cloneElement(r,U):(0,i.jsx)("a",{...K,...U,children:a}),(0,i.jsx)(w.Provider,{value:b,children:p})}e.r(17238);let w=(0,s.createContext)(f.IDLE_LINK_STATUS),b=()=>(0,s.useContext)(w);("function"==typeof o.default||"object"==typeof o.default&&null!==o.default)&&void 0===o.default.__esModule&&(Object.defineProperty(o.default,"__esModule",{value:!0}),Object.assign(o.default,o),t.exports=o.default)},31798,(e,t,o)=>{t.exports=e.r(61461)},13205,e=>{"use strict";var t=e.i(51466),o=e.i(6295),n=e.i(31798),a=e.i(79959),r=e.i(36696);let i=[{href:"/",label:"Home"},{href:"/letters",label:"Letters"},{href:"/time-capsule",label:"Time Capsules"},{href:"/birthday-vault",label:"Birthday Vault"},{href:"/milestones",label:"Milestones"},{href:"/about",label:"About"},{href:"/settings",label:"Settings"}];e.s(["default",0,function(){let e=(0,n.usePathname)(),[s,h]=(0,a.useState)(!1),[u,l]=(0,a.useState)("");return(0,a.useEffect)(()=>{try{l((0,r.getCurrentUser)())}catch{}},[]),(0,t.jsxs)("nav",{className:"border-b border-card",role:"navigation","aria-label":"Main navigation",children:[(0,t.jsxs)("div",{className:"max-w-5xl mx-auto px-4 flex items-center justify-between h-14",children:[(0,t.jsx)(o.default,{href:"/",className:"text-accent font-heading text-lg tracking-wide hover:opacity-80 transition-opacity shrink-0","aria-label":"Words to Santhi - Home",children:"Words to Santhi"}),(0,t.jsx)("div",{className:"hidden md:flex items-center gap-6",children:i.map(n=>(0,t.jsx)(o.default,{href:n.href,className:`text-sm transition-colors hover:text-accent ${e===n.href?"text-accent":"text-secondary"}`,children:n.label},n.href))}),(0,t.jsxs)("div",{className:"flex items-center gap-3",children:[(0,t.jsx)("span",{className:"text-xs font-heading tracking-wide text-secondary/70 bg-card border border-accent/10 rounded-full px-3 py-1",children:"kingsuk"===u?"Kingsuk":"Sania"}),(0,t.jsx)("button",{className:"md:hidden text-text p-2",onClick:()=>h(!s),"aria-label":s?"Close menu":"Open menu","aria-expanded":s,children:(0,t.jsx)("svg",{width:"24",height:"24",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:s?(0,t.jsx)("path",{d:"M6 18L18 6M6 6l12 12"}):(0,t.jsx)("path",{d:"M4 6h16M4 12h16M4 18h16"})})})]})]}),s&&(0,t.jsx)("div",{className:"md:hidden border-t border-card px-4 py-3 flex flex-col gap-3",role:"menu",children:i.map(n=>(0,t.jsx)(o.default,{href:n.href,onClick:()=>h(!1),className:`text-sm transition-colors hover:text-accent ${e===n.href?"text-accent":"text-secondary"}`,role:"menuitem",children:n.label},n.href))})]})}])},43222,e=>{"use strict";var t=e.i(51466),o=e.i(79959),n=e.i(24170),a=e.i(90037);e.s(["default",0,function(){let[e,r]=(0,o.useState)(!1),[i,s]=(0,o.useState)(!1),[h,u]=(0,o.useState)(0),l=n.letters.find(e=>"easter-egg"===e.id);return l?i?(0,t.jsx)(a.default,{letter:l,onClose:()=>{s(!1),r(!1),u(0)}}):(0,t.jsxs)("div",{className:"fixed bottom-4 right-4 z-50",role:"complementary","aria-label":"Hidden easter egg",children:[(0,t.jsx)("button",{onClick:()=>{let e=h+1;u(e),e>=5&&r(!0)},className:`w-10 h-10 rounded-full transition-all duration-300 ${e?"bg-accent cursor-pointer animate-glow":"bg-transparent border border-card hover:border-accent/30 cursor-pointer"}`,"aria-label":e?"Open secret letter":"Hidden button",title:"..."}),e&&(0,t.jsxs)("div",{className:"absolute bottom-14 right-0 bg-card border border-accent/30 rounded-lg p-4 shadow-xl min-w-48",children:[(0,t.jsx)("p",{className:"text-xs text-secondary mb-2",children:"You found it."}),(0,t.jsx)("button",{onClick:()=>s(!0),className:"text-accent text-sm hover:underline",children:"Open secret letter"})]})]}):null}])},27257,e=>{"use strict";var t=e.i(51466),o=e.i(79959),n=e.i(36696);let a={sania:"santhihidimbi",kingsuk:"kingsukisstillhuman"},r={background:"rgba(141,170,145,0.18)",border:"2.5px solid rgba(214,179,112,0.6)",boxShadow:"0 0 20px rgba(214,179,112,0.1), inset 0 0 15px rgba(141,170,145,0.08)"},i={color:"rgba(214,179,112,0.85)"};e.s(["default",0,function({children:e}){let[s,h]=(0,o.useState)("start"),[u,l]=(0,o.useState)(null),[d,y]=(0,o.useState)(""),[c,f]=(0,o.useState)(!1),[m,g]=(0,o.useState)(!1),[p,w]=(0,o.useState)(!1),[b,v]=(0,o.useState)(!1),[k,I]=(0,o.useState)(!1);(0,o.useEffect)(()=>{try{let e=(0,n.getCurrentUser)();if(sessionStorage.getItem("words-to-santhi-auth")===a[e]){h("authed"),I(!0);return}}catch{}h("active")},[]),(0,o.useEffect)(()=>{let e=()=>{h("active"),l(null),y(""),f(!1),g(!1),w(!1),v(!1),I(!1),setTimeout(()=>v(!0),100),setTimeout(()=>g(!0),900),setTimeout(()=>{w(!0),h("select")},2100)};return window.addEventListener("logout",e),()=>window.removeEventListener("logout",e)},[]),(0,o.useEffect)(()=>{if("active"!==s)return;let e=setTimeout(()=>v(!0),100),t=setTimeout(()=>g(!0),900),o=setTimeout(()=>{w(!0),h("select")},2100);return()=>{clearTimeout(e),clearTimeout(t),clearTimeout(o)}},[s]);let x=e=>{l(e),h("password")};if("authed"===s&&k)return(0,t.jsx)("div",{className:"animate-gate-enter",style:{willChange:"transform, opacity"},children:e});let T="select"===s;return(0,t.jsxs)("div",{className:`fixed inset-0 z-[100] flex flex-col items-center justify-center bg-bg overflow-hidden ${"leaving"===s?"animate-gate-exit":""}`,style:{willChange:"transform, opacity"},children:[(0,t.jsx)("div",{className:"absolute inset-0 bg-[radial-gradient(ellipse_at_center,rgba(214,179,112,0.03)_0%,transparent_70%)] pointer-events-none"}),("start"===s||"active"===s||"select"===s)&&(0,t.jsxs)("div",{className:"text-center",children:[(0,t.jsx)("h1",{className:"text-3xl sm:text-4xl font-heading text-text mb-2 animate-fade-in",children:"Words to Santhi"}),(0,t.jsx)("div",{className:`transition-all duration-700 ease-out overflow-hidden ${p?"opacity-100 max-h-20 mt-0":"opacity-0 max-h-0"}`,children:(0,t.jsx)("p",{className:"text-base text-secondary/80 font-heading mb-10",children:"Are you the sister or the brother?"})}),(0,t.jsx)("div",{className:"flex items-center justify-center mt-4 h-36",children:(0,t.jsxs)("div",{className:"relative w-56 h-36 flex items-center justify-center",children:[(0,t.jsx)("div",{className:`absolute w-14 h-14 rounded-full bg-accent/5 blur-xl transition-all duration-1000 ${b?"opacity-100":"opacity-0"}`}),(0,t.jsxs)("button",{onClick:()=>T&&x("sania"),disabled:!T,className:"absolute flex flex-col items-center gap-2",style:{willChange:"transform",transform:`translateX(${m?-76:0}px) translateZ(0)`,transition:"transform 1.4s cubic-bezier(0.34, 1.2, 0.64, 1)",pointerEvents:T?"auto":"none"},children:[(0,t.jsx)("div",{className:`w-[72px] h-[72px] rounded-full flex items-center justify-center text-xl font-heading transition-all duration-700 ${b?"opacity-100 scale-100":"opacity-0 scale-50"} ${T?"hover:shadow-lg cursor-pointer":""}`,style:{...r,transition:"opacity 0.7s ease-out, transform 0.7s cubic-bezier(0.34, 1.56, 0.64, 1), box-shadow 0.3s"},children:(0,t.jsx)("span",{style:i,children:"S"})}),(0,t.jsx)("span",{className:`text-sm font-heading transition-all duration-500 delay-200 ${p?"opacity-100 translate-y-0":"opacity-0 translate-y-2"}`,style:{color:T?"rgba(245,241,232,0.9)":"rgba(245,241,232,0.5)"},children:"Sania"})]}),(0,t.jsxs)("button",{onClick:()=>T&&x("kingsuk"),disabled:!T,className:"absolute flex flex-col items-center gap-2",style:{willChange:"transform",transform:`translateX(${76*!!m}px) translateZ(0)`,transition:"transform 1.4s cubic-bezier(0.34, 1.2, 0.64, 1)",pointerEvents:T?"auto":"none"},children:[(0,t.jsx)("div",{className:`w-[72px] h-[72px] rounded-full flex items-center justify-center text-xl font-heading transition-all duration-700 ${b?"opacity-100 scale-100":"opacity-0 scale-50"} ${T?"hover:shadow-lg cursor-pointer":""}`,style:{...r,transition:"opacity 0.7s ease-out, transform 0.7s cubic-bezier(0.34, 1.56, 0.64, 1), box-shadow 0.3s"},children:(0,t.jsx)("span",{style:i,children:"K"})}),(0,t.jsx)("span",{className:`text-sm font-heading transition-all duration-500 delay-200 ${p?"opacity-100 translate-y-0":"opacity-0 translate-y-2"}`,style:{color:T?"rgba(245,241,232,0.9)":"rgba(245,241,232,0.5)"},children:"Kingsuk"})]})]})})]}),"password"===s&&(0,t.jsxs)("div",{className:"text-center animate-fade-in w-full max-w-sm mx-auto px-4",children:[(0,t.jsx)("button",{onClick:()=>{l(null),y(""),f(!1),h("select")},className:"mb-6 text-xs text-secondary hover:text-text transition-colors",children:"← Back"}),(0,t.jsx)("div",{className:"w-[72px] h-[72px] mx-auto mb-4 rounded-full flex items-center justify-center text-xl font-heading",style:r,children:(0,t.jsx)("span",{style:i,children:"sania"===u?"S":"K"})}),(0,t.jsx)("h2",{className:"text-xl font-heading text-text mb-1 capitalize",children:u}),(0,t.jsx)("p",{className:"text-sm text-secondary/70 mb-6",children:"Enter your password"}),(0,t.jsxs)("form",{onSubmit:e=>{if(e.preventDefault(),d===a[u||""]){try{sessionStorage.setItem("words-to-santhi-auth",d)}catch{}h("leaving"),setTimeout(()=>{h("authed"),I(!0)},400)}else f(!0)},className:"flex flex-col gap-4",children:[(0,t.jsx)("input",{type:"password",value:d,onChange:e=>{y(e.target.value),f(!1)},placeholder:"Password",className:"w-full bg-card border border-accent/20 rounded-lg px-4 py-2.5 text-sm text-text placeholder-secondary/50 focus:outline-none focus:border-accent/50 transition-colors text-center",autoFocus:!0,"aria-label":"Password"}),c&&(0,t.jsx)("p",{className:"text-xs text-red-400",children:"Incorrect password. Try again."}),(0,t.jsx)("button",{type:"submit",className:"text-sm px-6 py-2.5 rounded-lg transition-all border",style:{background:"rgba(141,170,145,0.1)",borderColor:"rgba(214,179,112,0.3)",color:"rgba(214,179,112,0.85)"},children:"Enter"})]})]})]})}])},74011,e=>{"use strict";var t=e.i(51466),o=e.i(31798),n=e.i(79959);e.s(["default",0,function({children:e}){let a=(0,o.usePathname)(),[r,i]=(0,n.useState)("idle"),s=(0,n.useRef)(e),h=(0,n.useRef)(!0);(0,n.useEffect)(()=>{if(h.current){h.current=!1;return}i("covering");let t=setTimeout(()=>{s.current=e,i("revealing");let t=setTimeout(()=>{i("idle")},1e3);return()=>clearTimeout(t)},1e3);return()=>clearTimeout(t)},[a,e]);let u="idle"===r||"revealing"===r?e:s.current;return(0,t.jsxs)(t.Fragment,{children:[(0,t.jsx)("div",{style:{willChange:"transform, opacity"},children:u}),"idle"!==r&&(0,t.jsx)("div",{className:"covering"===r?"animate-blur-cover":"animate-blur-reveal",style:{position:"fixed",inset:0,zIndex:9999,pointerEvents:"none",backdropFilter:"blur(24px)",WebkitBackdropFilter:"blur(24px)",backgroundColor:"rgba(15, 17, 23, 0.25)",willChange:"mask-image, -webkit-mask-image"}})]})}])}]);