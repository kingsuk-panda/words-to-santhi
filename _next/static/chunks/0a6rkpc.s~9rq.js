(globalThis.TURBOPACK||(globalThis.TURBOPACK=[])).push(["object"==typeof document?document.currentScript:void 0,40924,(e,t,o)=>{"use strict";Object.defineProperty(o,"__esModule",{value:!0});var n={assign:function(){return h},searchParamsToUrlQuery:function(){return r},urlQueryToSearchParams:function(){return s}};for(var a in n)Object.defineProperty(o,a,{enumerable:!0,get:n[a]});function r(e){let t={};for(let[o,n]of e.entries()){let e=t[o];void 0===e?t[o]=n:Array.isArray(e)?e.push(n):t[o]=[e,n]}return t}function i(e){return"string"==typeof e?e:("number"!=typeof e||isNaN(e))&&"boolean"!=typeof e?"":String(e)}function s(e){let t=new URLSearchParams;for(let[o,n]of Object.entries(e))if(Array.isArray(n))for(let e of n)t.append(o,i(e));else t.set(o,i(n));return t}function h(e,...t){for(let o of t){for(let t of o.keys())e.delete(t);for(let[t,n]of o.entries())e.append(t,n)}return e}},47589,(e,t,o)=>{"use strict";Object.defineProperty(o,"__esModule",{value:!0});var n={DecodeError:function(){return p},MiddlewareNotFoundError:function(){return k},MissingStaticPage:function(){return v},NormalizeError:function(){return w},PageNotFoundError:function(){return b},SP:function(){return g},ST:function(){return m},WEB_VITALS:function(){return r},execOnce:function(){return i},getDisplayName:function(){return d},getLocationOrigin:function(){return u},getURL:function(){return l},isAbsoluteUrl:function(){return h},isResSent:function(){return y},loadGetInitialProps:function(){return f},normalizeRepeatedSlashes:function(){return c},stringifyError:function(){return I}};for(var a in n)Object.defineProperty(o,a,{enumerable:!0,get:n[a]});let r=["CLS","FCP","FID","INP","LCP","TTFB"];function i(e){let t,o=!1;return(...n)=>(o||(o=!0,t=e(...n)),t)}let s=/^[a-zA-Z][a-zA-Z\d+\-.]*?:/,h=e=>s.test(e);function u(){let{protocol:e,hostname:t,port:o}=window.location;return`${e}//${t}${o?":"+o:""}`}function l(){let{href:e}=window.location,t=u();return e.substring(t.length)}function d(e){return"string"==typeof e?e:e.displayName||e.name||"Unknown"}function y(e){return e.finished||e.headersSent}function c(e){let t=e.split("?");return t[0].replace(/\\/g,"/").replace(/\/\/+/g,"/")+(t[1]?`?${t.slice(1).join("?")}`:"")}async function f(e,t){let o=t.res||t.ctx&&t.ctx.res;if(!e.getInitialProps)return t.ctx&&t.Component?{pageProps:await f(t.Component,t.ctx)}:{};let n=await e.getInitialProps(t);if(o&&y(o))return n;if(!n)throw Object.defineProperty(Error(`"${d(e)}.getInitialProps()" should resolve to an object. But found "${n}" instead.`),"__NEXT_ERROR_CODE",{value:"E1025",enumerable:!1,configurable:!0});return n}let g="u">typeof performance,m=g&&["mark","measure","getEntriesByName"].every(e=>"function"==typeof performance[e]);class p extends Error{}class w extends Error{}class b extends Error{constructor(e){super(),this.code="ENOENT",this.name="PageNotFoundError",this.message=`Cannot find module for page: ${e}`}}class v extends Error{constructor(e,t){super(),this.message=`Failed to load static file for page: ${e} ${t}`}}class k extends Error{constructor(){super(),this.code="ENOENT",this.message="Cannot find the middleware module"}}function I(e){return JSON.stringify({message:e.message,stack:e.stack})}},99355,(e,t,o)=>{"use strict";Object.defineProperty(o,"__esModule",{value:!0}),Object.defineProperty(o,"warnOnce",{enumerable:!0,get:function(){return n}});let n=e=>{}},90037,e=>{"use strict";var t=e.i(51466),o=e.i(79959),n=e.i(29963),a=e.i(36696);e.s(["default",0,function({letter:e,onClose:r}){let[i,s]=(0,o.useState)("envelope"),h=(0,o.useCallback)(async()=>{await (0,a.addOpenedLetter)(e.id)},[e.id]);(0,o.useEffect)(()=>(s("envelope"),document.body.style.overflow="hidden",()=>{document.body.style.overflow=""}),[e.id]),(0,o.useEffect)(()=>{"open"===i&&h()},[i,h]);let u=(0,t.jsx)("div",{className:"fixed inset-0 z-50 bg-black/90 flex items-center justify-center p-4",onClick:e=>{e.target===e.currentTarget&&("envelope"===i?s("open"):r())},style:{position:"fixed",top:0,left:0,right:0,bottom:0,zIndex:50,backgroundColor:"rgba(0,0,0,0.9)",display:"flex",alignItems:"center",justifyContent:"center",padding:"1rem"},children:"envelope"===i?(0,t.jsx)("div",{className:"cursor-pointer will-change-transform animate-envelope-in",children:(0,t.jsxs)("div",{className:"w-64 max-w-full h-44 bg-accent/20 border border-accent/30 rounded-lg flex flex-col items-center justify-center gap-1 relative shadow-xl shadow-accent/10",children:[(0,t.jsx)("span",{className:"text-accent text-xs tracking-widest uppercase",children:"A Letter"}),(0,t.jsx)("span",{className:"text-text text-sm text-center px-4 font-heading",children:e.title}),(0,t.jsx)("span",{className:"text-secondary text-[10px] mt-2",children:"click to open"}),(0,t.jsx)("div",{className:"absolute top-3 right-3 w-6 h-6 border-t-2 border-r-2 border-accent/40 rounded-tr-sm"})]})}):(0,t.jsxs)("div",{className:"bg-card border border-accent/20 rounded-lg max-w-lg w-full flex flex-col animate-scale-in will-change-transform",onClick:e=>e.stopPropagation(),style:{maxHeight:"85vh"},children:[(0,t.jsxs)("div",{className:"flex items-center justify-between px-5 py-3 border-b border-accent/10 shrink-0",children:[(0,t.jsx)("div",{className:"min-w-0",children:(0,t.jsx)("h2",{className:"text-sm font-heading text-text truncate",children:e.title})}),(0,t.jsx)("button",{onClick:r,className:"shrink-0 text-secondary hover:text-text text-sm ml-4 p-2","aria-label":"Close letter",children:"✕"})]}),(0,t.jsx)("div",{className:"overflow-y-auto px-5 py-4 space-y-3 text-text text-sm leading-relaxed whitespace-pre-line min-h-0",children:e.content.split("\n").map((e,o)=>e.trim()?(0,t.jsx)("p",{children:e},o):(0,t.jsx)("br",{},o))})]})});return"u"<typeof document?null:(0,n.createPortal)(u,document.body)}])},24170,e=>{"use strict";let t=[{id:"when-you-need-a-laugh",title:"When You Need A Laugh",description:"For the days when everything feels too serious.",category:"letter",order:1,content:`Dear Santhi,
