export interface Letter {
  ...
  description: string;
  content: string;
  category: "letter" | "time-capsule" | "milestone" | "special" | "easter-egg" | "birthday";
  unlockDate?: string;
  order: number;
}
...
export const letters: Letter[] = [
  {
    id: "when-you-need-a-laugh",
    title: "When You Need A Laugh",
    description: "For the days when everything feels too serious.",
    category: "letter",
    order: 1,
    content: `Dear Santhi,
...
Fantastic Kingsuk`
  },
  {
    ...
    description: "A reminder that you are never truly alone.",
    category: "letter",
    order: 2,
    content: `Dear Santhi,
...
Kingsuk`
  ...
  {
    id: "when-you-think-youre-not-good-enough",
    title: "When You Think You're Not Good Enough",
    description: "For the voice in your head that is wrong about you.",
    category: "letter",
    order: 3,
    content: `Dear Santhi,
...
Kingsuk`
  ...
  {
    id: "when-somebody-hurt-you",
    title: "When Somebody Hurt You",
    description: "When the wounds are fresh and words feel inadequate.",
    category: "letter",
    order: 4,
    content: `Dear Santhi,
...
Kingsuk`
  ...
  {
    id: "when-you-feel-misunderstood",
    title: "When You Feel Misunderstood",
    description: "For when the world doesn't seem to get you.",
    category: "letter",
    order: 5,
    content: `Dear Santhi,
...
Kingsuk`
  },
  {
    ...
    description: "Distance is temporary. Friendship is not.",
    category: "letter",
    order: 6,
    content: `Dear Santhi,
...
Kingsuk`
  ...
  {
    id: "when-you-forget-your-worth",
    title: "When You Forget Your Worth",
    description: "A letter to remind you of your value.",
    category: "letter",
    order: 7,
    content: `Dear Santhi,
...
Kingsuk`
  ...
  {
    id: "after-your-worst-day",
    title: "After Your Worst Day",
    description: "For when you've survived the unsurvivable.",
    category: "letter",
    order: 8,
    content: `Dear Santhi,
...
Kingsuk`
  ...
  {
    id: "if-we-ever-lose-touch",
    title: "If We Ever Lose Touch",
    description: "A letter for the possibility of time and distance.",
    category: "letter",
    order: 9,
    content: `Dear Santhi,
...
Kingsuk`
  ...
  {
    id: "if-nobody-understands-you",
    title: "If Nobody Understands You",
    description: "For when you feel like you speak a different language.",
    category: "letter",
    order: 10,
    content: `Dear Santhi,
...
Kingsuk`
  },
  {
    ...
    description: "For the weight that won't lift.",
    category: "letter",
    order: 11,
    content: `Dear Santhi,
...
Kingsuk`
  ...
  {
    id: "when-you-need-a-brother",
    title: "When You Need A Brother",
    description: "For the moments only family can fill.",
    category: "letter",
    order: 12,
    content: `Dear Santhi,
...
Kingsuk`
  },
  {
    id: "one-month",
    title: "One Month",
    description: "A month has passed since this archive began.",
...
Kingsuk`
  },
  {
    id: "six-months",
    title: "Six Months",
    description: "Half a year of letters and friendship.",
    category: "time-capsule",
...
Kingsuk`
  },
  {
    id: "one-year",
    title: "One Year",
    description: "A full year has passed. Look how far you've come.",
    category: "time-capsule",
    unlockDate: "2027-05-31",
    order: 15,
    content: `Dear Santhi,
...
Kingsuk`
  },
  {
    id: "three-years",
    title: "Three Years",
    description: "Three years of knowing you. What a gift.",
    category: "time-capsule",
    unlockDate: "2029-05-31",
    order: 16,
    content: `Dear Santhi,
...
Kingsuk`
  },
  {
    id: "five-years",
    title: "Five Years",
    description: "Half a decade. Think of everything that's happened.",
    category: "time-capsule",
    unlockDate: "2031-05-31",
    order: 17,
    content: `Dear Santhi,
...
Kingsuk`
  },
  {
    id: "ten-years",
    title: "Ten Years",
    description: "A decade. This is getting serious.",
    category: "time-capsule",
    unlockDate: "2036-05-31",
    order: 18,
    content: `Dear Santhi,
...
Kingsuk`
  },
  {
    id: "fifteen-years",
    title: "Fifteen Years",
    description: "A decade and a half. Time flies.",
    category: "time-capsule",
    unlockDate: "2041-05-31",
    order: 19,
    content: `Dear Santhi,
...
Kingsuk`
  },
  {
    id: "twenty-years",
    title: "Twenty Years",
    description: "Two decades. What a journey.",
    category: "time-capsule",
    unlockDate: "2046-05-31",
    order: 20,
    content: `Dear Santhi,
...
Kingsuk`
  ...
  {
    id: "open-only-if-we-have-lost-touch",
    title: "Open Only If We Have Lost Touch",
    description: "This is one of the most important letters in the archive.",
    category: "special",
    order: 21,
    content: `Dear Santhi,
...
Kingsuk`
  ...
  {
    id: "first-job",
    title: "When You Get Your First Job",
...
Kingsuk`
  ...
  {
    id: "move-new-city",
    title: "When You Move To A New City",
    description: "New place. New chapter. Same you.",
    category: "milestone",
    order: 23,
    content: `Dear Santhi,
...
Kingsuk`
  ...
  {
    id: "first-home",
    title: "When You Buy Your First Home",
    description: "Four walls that are yours.",
    category: "milestone",
    order: 24,
    content: `Dear Santhi,
...
Kingsuk`
  ...
  {
    id: "when-you-think-you-failed",
    title: "When You Think You Failed",
    description: "Failure is not the opposite of success.",
    category: "milestone",
    order: 25,
    content: `Dear Santhi,
...
Kingsuk`
  ...
  {
    id: "burnout",
    title: "When You Experience Burnout",
    description: "Rest is not a reward. It's a necessity.",
    category: "milestone",
    order: 26,
    content: `Dear Santhi,
...
Kingsuk`
  ...
  {
    id: "huge-accomplishment",
    title: "When You Accomplish Something Huge",
    description: "You did it. Really did it.",
    category: "milestone",
    order: 27,
    content: `Dear Santhi,
...
Kingsuk`
  ...
  {
    id: "turn-30",
    title: "When You Turn 30",
    description: "A new decade begins.",
    category: "milestone",
    order: 28,
    content: `Dear Santhi,
...
Kingsuk`
  ...
  {
    id: "turn-40",
    title: "When You Turn 40",
    description: "Forty and fabulous.",
    category: "milestone",
    order: 29,
    content: `Dear Santhi,
...
Kingsuk`
  ...
  {
    id: "turn-50",
    title: "When You Turn 50",
    description: "Half a century of you.",
    category: "milestone",
    order: 30,
    content: `Dear Santhi,
...
Kingsuk`
  ...
  {
    id: "feel-old",
    title: "When You Feel Old",
    description: "Age is just a number. You are timeless.",
    category: "milestone",
    order: 32,
    content: `Dear Santhi,
...
Kingsuk`
  },
  {
    ...
    description: "You are not invisible. You are not forgotten.",
    category: "milestone",
    order: 33,
    content: `Dear Santhi,
...
Kingsuk`
  },
  {
    id: "wedding-day",
    title: "Wedding Day",
    description: "Today, you begin a new journey.",
    category: "milestone",
    order: 34,
    content: `Dear Santhi,
...
Kingsuk`
  ...
  {
    id: "easter-egg",
    title: "Open Only If You Found The Hidden Button",
    description: "You found it. Of course you did.",
    category: "easter-egg",
    order: 35,
    content: `Dear Santhi,
